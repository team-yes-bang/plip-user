...
@Tag(name = SwaggerTags.AUTH_TERMS, description = "가입·소셜 약관 API")
@RestController
@Order(2)
...
public class AuthTermsController {
	...
	@Operation(
			summary = "ACTIVE 약관 목록",
			description = "가입·소셜 약관 동의 UI용 ACTIVE 약관 목록. term_code당 version(major.minor) 최신 ACTIVE 1건만 반환."
	)
	@ApiResponses({
